...
function OnEventCustomWeather()
    ...
    elseif d == 9 then
        -- Fog
        local t1 = GetRandomNum(0, 20*60)
        local t2 = t1 + 22*60 + GetRandomNum(0, 20*60)
        SysCall("ScenarioManager:TriggerDeferredEvent", "LightRainShowerFog" .. GetRandomNum(1,6), t1);
        SysCall("ScenarioManager:TriggerDeferredEvent", "LightRainShowerFog" .. GetRandomNum(1,6), t2);
    elseif d == 10 then
        -- Fair
    elseif d == 11 then
        -- Fair
    ...
    elseif d == 22 then
        ...
        local t1 = GetRandomNum(0, 20*60)
        local t2 = t1 + 22*60 + GetRandomNum(0, 20*60)
        SysCall("ScenarioManager:TriggerDeferredEvent", "LightRainShower" .. GetRandomNum(1,6), t1);
        SysCall("ScenarioManager:TriggerDeferredEvent", "LightRainShower" .. GetRandomNum(1,6), t2);
    elseif d == 23 then
        -- Overcast
        if GetRandomNum(1, 2) == 1 then
            SysCall("ScenarioManager:TriggerDeferredEvent", "OvercastClear", 0);
